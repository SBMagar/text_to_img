...
from text_to_img.image_utils import combine_normalized_images, img_from_normalized_img
...
class DCGan(object):
    ...
    def fit(self, model_dir_path, image_label_pairs, epochs=None, batch_size=None, snapshot_dir_path=None,
        ...
        noise = np.zeros((batch_size, self.text_input_dim))
        ...
        for epoch in range(epochs):
            ...
            for batch_index in range(batch_count):
                image_label_pairs_batch = image_label_pairs[batch_index * batch_size:(batch_index + 1) * batch_size]

                image_batch = []
                for index in range(batch_size):
                    image_label_pair = image_label_pairs_batch[index]
